...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=1]{../../../Pictures/Script/cjb.jpg}
\end{figure}
\newpage
\tableofcontents
\newpage
...
\begin{itemize}
	\item \textbf{1 Ordinateur} pour administrer l'un des serveurs qui sera utilisé.
...
Pour installer OCS Inventory NG, j'ai utilisé l'archive qui était sur le site et la documentation non à jour (cf.Références).
\newpage
\section{Déploiement}
...
\item L'utilisation de PSEXEC va créer un dossier utilisateur sur l'ordinateur distant... Résolu avec un script qui force le déploiement de l'inventaire OCS et supprime le dossier utilisateur.
