...
\begin{itemize} 
	...
	\item Est-ce que le script s'est déroulé de manière "silencieux" ? Si non, voir la syntaxe spécifique d'un fichier .EXE ou d'un Package .MSI. \\
\end{itemize}
...
La page finale de création du paquet montre le poids du paquet, le nombre de fragment du paquets pour pas saturer le réseau lors du déploiement de gros paquet (c'est pas notre cas) et le temps estimé pour le déploiement (qui affiche souvent rien ou le mauvais temps)
